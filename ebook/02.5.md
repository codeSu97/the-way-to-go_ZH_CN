...
如果你想要测试安装，则可以使用指令 `go run` 运行 [hello\_world1.go](https://github.com/codeSu97/the-way-to-go_ZH_CN/tree/cb9c3473071aa65151922c4b563acfdbbf0b71e5/eBook/examples/chapter_2/hello_world1.go)。
