...
![](https://github.com/codeSu97/the-way-to-go_ZH_CN/tree/cb9c3473071aa65151922c4b563acfdbbf0b71e5/eBook/images/10.7_fig.jpg?raw=true)
...
1）stack\_arr.go：使用长度为 4 的 int 数组作为底层数据结构。

2）stack\_struct.go：使用包含一个索引和一个 int 数组的结构体作为底层数据结构，索引表示第一个空闲的位置。
