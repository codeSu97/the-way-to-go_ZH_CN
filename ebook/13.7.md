...
备注：gotest 是 Unix bash 脚本，所以在 Windows 下你需要配置 MINGW 环境（参见 [2.5 节](02.5.md)）；在 Windows 环境下把所有的 pkg/linux\_amd64 替换成 pkg/windows。
...
具体可以参见 [14.16 节](14.16.md)中用 goroutines 运行基准测试的例子以及练习 13.4：[string\_reverse\_test.go](https://github.com/codeSu97/the-way-to-go_ZH_CN/tree/cb9c3473071aa65151922c4b563acfdbbf0b71e5/eBook/exercises/chapter_13/string_reverse_test.go)
